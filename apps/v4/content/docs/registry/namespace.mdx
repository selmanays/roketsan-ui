...
We intentionally designed the namespace system to be decentralized. There is a [central registry index](/docs/registry/registry-index) for namespaces but you are free to create and use any namespace you want.
